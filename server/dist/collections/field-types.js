...
exports.FIELD_TYPE_MAP = exports.FieldTypeCategory = void 0;
exports.getPgType = getPgType;
exports.getUIComponent = getUIComponent;
exports.isSearchable = isSearchable;
exports.isSortable = isSortable;
exports.isFilterable = isFilterable;
exports.getFieldTypesByCategory = getFieldTypesByCategory;
var FieldTypeCategory;
(function (FieldTypeCategory) {
    FieldTypeCategory["BASIC"] = "basic";
    FieldTypeCategory["DATE"] = "date";
    FieldTypeCategory["MEDIA"] = "media";
    FieldTypeCategory["RELATION"] = "relation";
    FieldTypeCategory["SELECTION"] = "selection";
    FieldTypeCategory["ADVANCED"] = "advanced";
    FieldTypeCategory["SYSTEM"] = "system";
})(FieldTypeCategory || (exports.FieldTypeCategory = FieldTypeCategory = {}));
...
function getPgType(fieldType) {
    return exports.FIELD_TYPE_MAP[fieldType]?.postgresType || 'TEXT';
}
/**
 * Get UI component for a given field type
 */
function getUIComponent(fieldType) {
    return exports.FIELD_TYPE_MAP[fieldType]?.uiComponent || 'text-input';
}
/**
 * Check if field type is searchable
 */
function isSearchable(fieldType) {
    return exports.FIELD_TYPE_MAP[fieldType]?.searchable || false;
}
/**
 * Check if field type is sortable
 */
function isSortable(fieldType) {
    return exports.FIELD_TYPE_MAP[fieldType]?.sortable || false;
}
/**
 * Check if field type is filterable
 */
function isFilterable(fieldType) {
    return exports.FIELD_TYPE_MAP[fieldType]?.filterable || false;
}
/**
 * Get all field types by category
 */
function getFieldTypesByCategory(category) {
    return Object.entries(exports.FIELD_TYPE_MAP)
