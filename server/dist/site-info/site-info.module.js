...
const site_info_controller_1 = require("./site-info.controller");
...
exports.SiteInfoModule = SiteInfoModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [site_info_controller_1.SiteInfoController],
        providers: [site_info_service_1.SiteInfoService],
        exports: [site_info_service_1.SiteInfoService],
    })
], SiteInfoModule);
